...
% level three
\newcommand\milinelvbt[3]{\CJKgrid{\kaishu #1\color{gray!40}\whzkjk #1\color{gray!20}\kaishu #1 #1\color{white}\whzkjk #1 #1\color{white}\kaishu #1 #1 #1\color{white}#3 #3 #3} }

\newcommand\milinelvb[1]{\milinelvbt{#1}{厂}{水}}
